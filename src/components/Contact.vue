<template>
	<div class="flex justify-center items-center bg-blue-200 dark:bg-red-500 rounded-3xl shadow-xl mt-32 mb-5 border-2 border-blue-300 dark:border-red-600 crd-blue crd-red" id="contact" data-aos="flip-right" data-aos-duration="1000">
	  <div class="container mx-auto">
		<h1 class="flex justify-center text-2xl md:text-3xl dark:text-slate-200 mx-auto py-10">Drop me a message<span class="animate-pulsing">|</span></h1>
