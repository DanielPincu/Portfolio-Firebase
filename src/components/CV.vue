...
<template>
  <div v-if="databaseLoaded">
    ...
    <div class="border-b-2 border-zinc-200 pb-5 mb-16" data-aos="fade-right" data-aos-duration="1000">
      <h1 v-if="databaseLoaded" class="text-2xl font-bold text-center mt-5" data-aos="fade-up">Daniel Pincu</h1>
      <p v-if="databaseLoaded" class="text-center text-gray-500" data-aos="fade-up">Front-end developer</p>
    </div>

    <div>
      <div v-for="item in my_info" class="crd-blue crd-red shadow-xl text-xl border-2 border-blue-300 dark:border-red-300 mx-5 mt-5 flex flex-col bg-blue-200 dark:bg-red-200 rounded-full items-center justify-end h-16" data-aos="fade-up" data-aos-duration="2000">
    ...
    <div class="pt-10">
      <h1 v-if="databaseLoaded" class="font-bold text-2xl text-center pt-5" data-aos="fade-up">Languages</h1>
    ...
    <div class="pt-10">
      <h1 v-if="databaseLoaded" class="font-bold text-2xl text-center pt-5" data-aos="fade-up">Skills</h1>
    ...
    <div class="pt-10">
      <h1 v-if="databaseLoaded" class="font-bold text-2xl text-center pt-5" data-aos="fade-up">Tools</h1>
  ...
  <div class="pt-10 sticky top-0">
      <h1 v-if="databaseLoaded" class="font-bold text-2xl text-center pt-5" data-aos="fade-up">Hobbies</h1>
