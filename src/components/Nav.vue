<template>
  <div class="flex justify-center sticky top-[100px]">
   <label class="inline-flex items-center cursor-pointer pt-20">
     ...
     <div @click="toggleDark()" class="relative w-11 h-6 bg-red-900  rounded-full peer dark:bg-red-600 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
   </label>
  </div>
 ...
 import { navItems } from "../modules/nav.js";
